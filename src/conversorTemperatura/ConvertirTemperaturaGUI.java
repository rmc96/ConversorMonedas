...
public class ConvertirTemperaturaGUI extends JDialog {
	/**
	 * 
	 */
	 ...
	 * Create the frame.
	 */
	public ConvertirTemperaturaGUI(JFrame parent) {

        super(parent, "Convertir Temperatura", true); // The "true" parameter makes it a modal dialog
		...
		JLabel label = new JLabel("Ingresa el valor que desea convertir");
		...
		JLabel labelText = new JLabel("Elija una opción para convertir");
		...
		String[] tipos = {"Grados Celcius a Grados Farenheit", "Grados Celcius a Kelvin", "Grados Farenheit a Grados Celcius","Kelvin a Grados Celcius","Kelvin a Grados Farenheit"};
        ...
        btnConvertir.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		if(ValidarNumero(input) == true && input!= "") {
                    ...
                    String resultado = temperatura.ConvertirTemperatura(valor, comboSelect);
